defmodule Phoenix.Channels.GenSocketClient.Transport do
  ...
  @type frame :: {:text | :binary, Phoenix.Channels.GenSocketClient.encoded_message()}
  @type transport_pid :: pid

  @doc "Invoked from the socket process to start the transport process."
  @callback start_link(url :: String.t(), Phoenix.Channels.GenSocketClient.transport_opts()) ::
